## Doesn't actually run unless copy-pasted into ScheduleMan.py in the appropriate fashion
## In other words, it works for Linux users and breaks for Mac users.
