...
class Moderation(commands.Cog):
    ...
    async def kick(self, ctx, person: discord.Member, *, reason = ""):
        ...
        try:
            ...
            await ctx.send("Failed to kick {}. Try making sure that I have the `kick members` role, or move my role to the top of the list.".format(person.mention),allowed_mentions=discord.AllowedMentions(users=False))
